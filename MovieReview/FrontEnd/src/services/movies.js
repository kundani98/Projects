...
class MovieDataService {
    ...
    getAll(page = 0) {
        return axios.get(`https://moviesreview-back-end.onrender.com/api/v1/movies?page=${page}`)        
    }

    get(id) {
        return axios.get(`https://moviesreview-back-end.onrender.com/api/v1/movies/id/${id}`)        
    }
    ...
    getRatings() {
        return axios.get("https://moviesreview-back-end.onrender.com/api/v1/movies/ratings")
    }
}
